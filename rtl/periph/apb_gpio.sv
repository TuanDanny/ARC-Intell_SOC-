/*
 * Module: apb_gpio
 * Description: Bộ điều khiển GPIO (General Purpose Input/Output) 32-bit.
 *              - Hỗ trợ giao diện APB v3.0 Slave.
 *              - Cơ chế đồng bộ hóa đầu vào (Input Synchronization) tránh hiện tượng Metastability.
 *              - Cấu hình ngắt (Interrupt) linh hoạt: Cạnh lên, cạnh xuống, hoặc cả hai.
 *              - Cơ chế Fail-safe tại chân vật lý.
