 ...
 * Description: Self-Checking Testbench v2.0 - Tích hợp hệ thống Radar theo dõi luồng.
 * Status: FIXED (Đã dời vị trí khai báo biến để sửa lỗi Undefined variable)
 */
`timescale 1ns/1ps
...
module tb_professional;
    ...
    initial begin
        ...
        #5000;
        $display("\n*************************************************************************");
        $display("   SoC DA VUOT QUA 10/10 THU THACH!       ");
        $display("*************************************************************************");
